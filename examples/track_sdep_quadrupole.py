...
h = 0.0
length = s[-1]
A_magnet_entry = bpmeth.GeneralVectorPotential(h=h, b=(b1, b2, b3))
...
h = 0.0
length = 5
A_magnet_body = bpmeth.GeneralVectorPotential(h=h, b=(b1, b2, b3))
H_magnet_body = bpmeth.Hamiltonian(length=length, h=h, vectp=A_magnet_body)
...
h = 0.0
length = s[-1]
A_magnet_exit = bpmeth.GeneralVectorPotential(h=h, b=(b1, b2, b3))
H_magnet_exit = bpmeth.Hamiltonian(length=length, h=h, vectp=A_magnet_exit)
